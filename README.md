...
The full list of all changes is visible in the changelog below.
---
...
Netherblast
- Fixed bug with casting that made it not go into cooldown and was able to select for crits by cancelling until a crit was visible.
...
- The Entropic Maw turns into the more powerful hungering mouth.
- The mouth can draw all enemies in radius 10 for 2 spaces towards itself or taunt nearby enemies with its tendrils.
